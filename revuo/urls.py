...
urlpatterns = patterns('',
    ...
    url(r'^restricted/N/add$', NewItem.as_view(category='N'), 
        name='add_news'),
    url(r'^restricted/B/add$', NewItem.as_view(category='B'), 
        name='add_blog'),
    url(r'^restricted/P/add$', NewItem.as_view(category='P'),
    ...
    url(r'^restricted/publisher/(?P<category>[VNBP])/(?P<item_id>\d+)$', 
        PublishItem.as_view()),
